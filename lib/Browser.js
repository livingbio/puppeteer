...
class Browser extends EventEmitter {
  ...
  static async create(connection, options, process, closeCallback) {
    ...
    if (options && options.deterministic) {
      ...
      await connection.send('Browser.deterministicMode', params);
    }
    return browser;
  }
  ...
  async _targetCreated(event) {
    ...
    const target = new Target(targetInfo, () => this._connection.createSession(targetInfo.targetId), this._ignoreHTTPSErrors, this._appMode, this._screenshotTaskQueue, this._deterministic);
